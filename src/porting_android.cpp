...
/* for it right now */
extern "C" {
	JNIEXPORT void JNICALL Java_com_freecraft_pocket_edition_GameActivity_putMessageBoxResult(
			JNIEnv *env, jclass j_this, jstring text)
	{
		errorstream << "Java_com_freecraft_pocket_edition_GameActivity_putMessageBoxResult got: "
...
void initAndroid()
{
	...
	nativeActivity = findClass("com/freecraft/pocket/edition/GameActivity");
	if (nativeActivity == 0) {
		errorstream <<
...
void initializePathsAndroid()
{
	...
	path_user    = path_storage + DIR_DELIM + "Android/data/com.freecraft.pocket.edition/Files";
